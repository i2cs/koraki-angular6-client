...
export interface IntegrationConfigurationsDataViewModel { 
    enabled?: boolean;
    templateCode?: string;
    templateName?: string;
    ...
    templateDefaultContent?: string;
    sampleNotification?: string;
    sampleVariables?: { [key: string]: any; };
    image?: string;
    variables?: Array<VariableDetails>;
    inputs?: Array<InputsDetails>;
}
