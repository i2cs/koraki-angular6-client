...
export class PrivyService {
    ...
    public getWebhookUrl(applicationId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (applicationId === null || applicationId === undefined) {
            throw new Error('Required parameter applicationId was null or undefined when calling getWebhookUrl.');
        }
        ...
        return this.httpClient.get<string>(`${this.basePath}/modules/v1.0/Privy/Webhook`,
            {
